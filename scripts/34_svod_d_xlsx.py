...
notes = [
    ...
    'Схема D (уточнённая детекция ДХ, полная VLM-верификация): 36 зон + 6 ЦУ = 42 ОРШ; заполнение сплиттеров 1:64 — 75-100%; ср. волоконный маршрут ДХ 278 м (против 1361 м в централизованной). Карты зон ОРШ по всем СНП — download/snp_vko.',
