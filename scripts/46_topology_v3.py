# -*- coding: utf-8 -*-
"""
Шаг 46. Топология v3: граница НП + ОРШ в центре сектора + фидеры Дейкстрой.
...
Выход: work/boq_decentral_data_v3.json (формат зеркалит v2 для шагов 30/34/37-40)
       work/topology_v3_summary.json (A/B, сдвиги ОРШ, граница)
"""
import json
import math
...
def main():
    ...
    json.dump(data, open(f'{BASE}/work/boq_decentral_data_v3.json', 'w', encoding='utf-8'),
    ...
    json.dump(js, open(f'{BASE}/work/topology_v3_summary.json', 'w', encoding='utf-8'),
              ensure_ascii=False, indent=1)
    ...
    print('\nСохранено: work/boq_decentral_data_v3.json, work/topology_v3_summary.json')
