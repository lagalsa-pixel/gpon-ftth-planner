...
def title_page(c):
    ...
    subs = ('Децентрализованная структура: зонные ОРШ (сплиттеры 1:64)',
            ...
            '3 087 обслуживаемых домохозяйств · 36 зонных ОРШ + 6 ЦУ · ОРШ в центрах секторов, фидеры в границе НП')
    for s in subs:
    ...
    c.drawRightString(W - M, 52, 'ВКО · 6 СНП · 3087 ДХ')
