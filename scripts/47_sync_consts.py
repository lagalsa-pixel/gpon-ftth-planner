...
Task 52: OLD-константы обновлены на состояние книги до пересборки
(2765 ДХ, 28 зон, 58 сплиттеров, 1112 муфт, 6213 сварок, 4560 портов,
1474,4 вол-км, 304 м) — книга пересобирается из network_hh3 (кратчайшие
трассы Task 52).
"""
import io
import json
...
# состояние книги ДО пересборки Task 52 (Task 49)
OLD = dict(dhx=2765, zones=28, orsh=34, splitters=58, mufty=1112,
           splices=6213, ports=4560, fiber=1474.4, route=304)
